...
from les_caribousbb import Les_caribousBB
...
def test_bb():
    ...
    a1 = Les_caribousBB(1, 8, budget)
    a2 = Les_caribousBB(2, 10, budget)
    a3 = Les_caribousBB(3, 20, budget)
