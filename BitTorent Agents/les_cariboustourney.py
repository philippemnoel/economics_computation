...
# BitTorent Tournament Client, strategies discussed in the writeup
import math
import random
import logging
...
def update_prev_unchoked_peers(self, round, history, alpha, gamma, r):
...
################################################################################
class Les_caribousTourney(Peer):
